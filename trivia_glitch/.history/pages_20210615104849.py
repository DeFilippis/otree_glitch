...
class Wait_Instructions(WaitPage):
    title_text = "Waiting for your Partner"
    body_text = "You are waiting on you partner to finish reading the rules of the round. This should take a maximum of 2 minutes for Phase 1 and 60 seconds for Phase 2 and Phase 3. Please refresh the webpage if you are still waiting after that time. If, after several refreshes, you are still stuck on this page, please contact me at defilippis@gmail.com."
