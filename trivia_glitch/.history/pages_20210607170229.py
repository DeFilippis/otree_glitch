...
class Basic_Wait(WaitPage):
    ...
    body_text = "You are waiting on you partner to move onto the next page. If you see this page for more than a few minutes, please contact me at defilippis@gmail.com."
