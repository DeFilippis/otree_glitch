...
class Wait_For_Partner(LeavableWaitPage):
    ...
    def vars_for_template(self):
        return dict(
            leavable_wait_page_success = '''Thank you for completing the intake form. We are waiting for other mTurkers to complete the survey. The moment someone else completes their intake form you will be paired up with them. 
            
            After 15 minutes of waiting, a button will appear allowing you to exit the game. You will be given a code that you should email to me at defilippis@gmail.com. I will then create a compensation HIT for $2.00 to compensate you for your time. Please note that if you arrived to this HIT over 20 minutes late, you will not be eligible for any payment, as mentioned on during scheduling. <p></p>''',
